...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/bootstrap-rtl.css')); ?>" media="all" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/rtl.css')); ?>" media="all" />
                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="urbianxNav">
                            ...
                            <ul class="navbar-nav mr-auto" id="urbianxMenu">
                               <!-- =============================== menu ================ -->
                                  <?php echo e(menu('Top-menu-arabic')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2">
                                        <a class="dropdown-item" href="<?php echo e(route('login')); ?>"><i class=" icon-feather-user"></i> مرحبا بالضيف</a>
                                        <a class="dropdown-item" href="<?php echo e(route('register')); ?>"><i class=" icon-feather-log-in"></i> سجل لتكون واحد منا</a>
                                    </div>
                                </li>
                            </div> 
                            <!-- Signin btn -->  
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                        <a class="dropdown-item" href="<?php echo e(url('/admin/users')); ?>"><i class="icon-line-awesome-users"></i> تفعيل القوائم </a>
                                        <a class="dropdown-item" href="<?php echo e(url('/admin')); ?>"><i class="icon-material-outline-settings"></i> الإعدادات</a>
                                        <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('الخروج')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-flag"></i> الملف الشخصي </a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-heart"></i> مفضل</a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>/edit"><i class="icon-feather-edit"></i> تعديل الملف الشخصي</a>
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('الخروج')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-flag"></i> الملف الشخصي </a>
                                <a class="dropdown-item" href="<?php echo e(url('Listes')); ?>/create"><i class="icon-material-outline-assignment"></i> إضافة قائمة  </a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>/edit"><i class="icon-feather-edit"></i> تعديل الملف الشخصي</a>
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('الخروج')); ?>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>حقوق النشر   &copy; جميع الحقوق محفوظة  2020  | <?php echo e(setting('site.adress')); ?> | Tel <?php echo e(setting('site.Phone')); ?> 
...
<?php /**PATH C:\xampp\htdocs\zams\urbainx-32\codecanyon-23430909-urbainx-modern-directory-listing-script-theme\Urbainx\resources\views/arabic/layout/main.blade.php ENDPATH**/ ?>