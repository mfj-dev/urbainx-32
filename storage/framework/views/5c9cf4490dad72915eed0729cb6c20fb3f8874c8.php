        ...
        <div class="row h-100 align-items-center justify-content-center">
            <div class="col-12 col-md-10">
                <div class="hero-content">
                    <h2><?php echo e(setting('home.Title-home-German')); ?></h2>
                    <h4><?php echo e(setting('home.Sub-home-German')); ?></h4>
                </div>
                <!-- Hero Search Form -->
                <div class="hero-search-form">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active"  role="tabpanel" aria-labelledby="nav-places-tab" >
                            <h6><?php echo e(setting('home.home-Search-German')); ?></h6>
                            <!-- ======================================================= Tabs Content  ==================== -->
                            ...
                            <select class="custom-select" name="search">
                                ...
                                <option value="<?php echo e($City->id); ?>"><?php echo e($City->City_name_german); ?></option>
                            ...
                            <select class="custom-select" name="search_cat">
                                ...
                                <option value="<?php echo e($Category->id); ?>"><?php echo e($Category->name_german); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <!-- ======================================================= Tabs Content  ==================== -->
                            </select>
        ...
        <div class="row">
            <div class="col-12">
                <div class="about-content text-center">
                    <h2><?php echo e(setting('catagory-area.Tiltle-area-about-german')); ?></h2>
                    <p><?php echo e(setting('catagory-area.Content-area-about-German')); ?></p>
                </div>
            </div>
            <div class="col-12">  
                <!-- ======================================================= ads Content  ==================== -->
        ...
        <div class="hover06 col-12 col-lg-4">
            <div class="single-features-area" style="background: transparent;">
                ...
                <div class="price-start">
                    <!-- ======================================================= media Content  ==================== -->
                    <p><?php echo e($City->City_name_german); ?></p>
                    <!-- ======================================================= media Content  ==================== -->
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="features-slides owl-carousel">
                    ...
                    <div class="single-features-area">
                        ...
                        <!-- Price -->
                        <div class="price-start">
                           <?php if(isset($Liste->Cite->City_name_german)): ?> 
                            <p><?php echo e($Liste->Cite->City_name_german); ?> | <?php if($Liste->active == 0): ?> Closed Now! <?php else: ?> Open Now! <?php endif; ?></p>
                           <?php else: ?>
                           <?php endif; ?>
                        </div>
                        <div class="feature-content d-flex align-items-center justify-content-between">
                            <a href="<?php echo e(url('Listes')); ?>/<?php echo e($Liste->slug); ?>"><div class="feature-title">
                             <h5><a href="<?php echo e(url('Listes')); ?>/<?php echo e($Liste->slug); ?>"><?php echo e($Liste->List_name_german); ?></a>
                               ...
                               <?php if(isset($Liste->User->name)): ?> 
                                <p><?php echo e($Liste->User->name); ?> | <?php echo e($Liste->Price_Range); ?> | <?php echo e($Liste->Category->name_german); ?></p>
                               <?php else: ?>
                               <?php endif; ?>
                               </div>
                           </a>
                    ...
                    <div class="feature-content d-flex align-items-center justify-content-between">
                        <a href="<?php echo e(url('Listes')); ?>/<?php echo e($Liste->slug); ?>">
                            <div class="feature-title">
                             <h5><?php echo e($Liste->List_name_german); ?>
        ...
        <div class="col-6">
            <div class="single-feature-events-area d-sm-flex align-items-center">
                ...
                <div class="feature-events-content">
                    <h5><?php echo substr($Post->title_german, 0, 40); ?></h5>
                    <p><?php echo substr($Post->body_german, 0, 90); ?></p>
                </div>
                <!-- ======================================================= news Content  ==================== -->
...
<?php echo $__env->make('German.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zams\urbainx-32\codecanyon-23430909-urbainx-modern-directory-listing-script-theme\Urbainx\resources\views/German/home.blade.php ENDPATH**/ ?>