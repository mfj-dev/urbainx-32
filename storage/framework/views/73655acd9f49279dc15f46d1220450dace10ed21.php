...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="urbianxNav">
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-flag"></i> Profile </a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class=" icon-material-outline-extension"></i> My Listings  </a>
    ...
    <!-- ***** Header Area End ***** -->
    <!-- ***** urb Area Start ***** -->
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url('<?php echo e(asset(Voyager::image(setting('home.Background-home')))); ?>')"></div>
    <!-- ***** urb Area End ***** -->
    <!-- ==================== ***** Header Area End ***** ======================== -->
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>Copyright &copy; All rights reserved 2020 | <?php echo e(setting('site.adress')); ?> | Tel <?php echo e(setting('site.Phone')); ?></p>
                    </div>
    ...
    <!-- ================ common_scripts ============= -->
    <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery-migrate-3.0.0.min.js')); ?>"></script>
    <!-- ================ common_scripts ============= -->
    ...
    <!-- =============================== javascript ================ -->
    <script type="text/javascript" src="<?php echo e(asset('assets/js/maps.js')); ?>"></script>
    <!-- ================ common_scripts ============= -->
    <script type="text/javascript" src="<?php echo e(asset('assets/js/active.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\zams\urbainx-32\codecanyon-23430909-urbainx-modern-directory-listing-script-theme\Urbainx\resources\views/english/layout/inside.blade.php ENDPATH**/ ?>