<?php $__env->startSection('media-manager'); ?>
<div>
                ...
                <div class="file_link selected" aria-hidden="true" data-toggle="tooltip" data-placement="auto" :title="file">
                    <div class="link_icon">
                        <template v-if="fileIs(file, 'image')">
                            <div class="img_icon" :style="imgIcon('<?php echo e(Storage::disk(config('voyager.storage.disk'))->url('/')); ?>'+file)"></div>
                        </template>
    ...
    <div v-if="hidden_element">
        <div class="btn btn-sm btn-default" v-on:click="isExpanded = !isExpanded;" style="width:100%">
            <div v-if="!isExpanded"><i class="voyager-double-down"></i> <?php echo e(__('voyager::generic.open')); ?></div>
            <div v-if="isExpanded"><i class="voyager-double-up"></i> <?php echo e(__('voyager::generic.close')); ?></div>
        </div>
    </div>
    <div id="toolbar" v-if="showToolbar" :style="isExpanded ? 'display:block' : 'display:none'">
        ...
        <div class="btn-group offset-right">
            <button type="button" :disabled="selected_files.length == 0" v-if="allowUpload && hidden_element" class="btn btn-default" v-on:click="addSelectedFiles()">
                <i class="voyager-upload"></i>
                <?php echo e(__('voyager::media.add_all_selected')); ?>
            ...
            <button type="button" v-if="showFolders && allowMove" class="btn btn-default" data-toggle="modal" :data-target="'#move_files_modal_'+this._uid">
                ...
                <?php echo e(__('voyager::generic.move')); ?>
        ...
        <div class="breadcrumb-container">
            <ol class="breadcrumb filemanager">
                <li class="media_breadcrumb" v-on:click="setCurrentPath(-1)">
                    ...
                    <strong><?php echo e(__('voyager::media.library')); ?></strong>
                </li>
            ...
            <div id="right">
                <div class="right_details">
                    <div v-if="selected_files.length > 1" class="right_none_selected">
                        ...
                        <p>{{ selected_files.length }} <?php echo e(__('voyager::media.files_selected')); ?></p>
                    </div>
                    <div v-else-if="selected_files.length == 1" class="right_details">
                        ...
                        <div class="detail_info">
                            <span>
                                <h4><?php echo e(__('voyager::media.title')); ?>:</h4>
                            ...
                            <span>
                                <h4><?php echo e(__('voyager::media.type')); ?>:</h4>
                                <p>{{ selected_file.type }}</p>
                            </span>

                            <template v-if="!fileIs(selected_file, 'folder')">
                                <span>
                                    <h4><?php echo e(__('voyager::media.size')); ?>:</h4>
                                    <p><span class="selected_file_size">{{ bytesToSize(selected_file.size) }}</span></p>
                                </span>
                                <span>
                                    <h4><?php echo e(__('voyager::media.public_url')); ?>:</h4>
                                    <p><a :href="selected_file.path" target="_blank"><?php echo e(__('voyager::generic.click_here')); ?></a></p>
                                </span>
                                <span>
                                    <h4><?php echo e(__('voyager::media.last_modified')); ?>:</h4>
    ...
    <div class="modal fade modal-info" :id="'create_dir_modal_'+this._uid">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input name="new_folder_name" placeholder="<?php echo e(__('voyager::media.new_folder_name')); ?>" class="form-control" value="" v-model="modals.new_folder.name" />
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel')); ?></button>
                    <button type="button" class="btn btn-info" v-on:click="createFolder"><?php echo e(__('voyager::media.create_new_folder')); ?>
    ...
    <div class="modal fade modal-danger" :id="'confirm_delete_modal_'+this._uid" v-if="allowDelete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4><?php echo e(__('voyager::media.delete_question')); ?></h4>
                    <ul>
                        <li v-for="file in selected_files">{{ file.name }}</li>
                    </ul>
                    <h5 class="folder_warning">
                        <i class="voyager-warning"></i> <?php echo e(__('voyager::media.delete_folder_question')); ?>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel')); ?></button>
                    <button type="button" class="btn btn-danger" v-on:click="deleteFiles"><?php echo e(__('voyager::generic.delete_confirm')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" v-model="modals.move_files.destination">
                        <option value="" disabled><?php echo e(__('voyager::media.destination_folder')); ?></option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel')); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="moveFiles"><?php echo e(__('voyager::generic.move')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade modal-warning" :id="'crop_modal_'+this._uid" v-if="allowCrop">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><?php echo e(__('voyager::media.crop_image')); ?></h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="new-image-info">
                        <?php echo e(__('voyager::media.width')); ?> <span :id="'new-image-width_'+this._uid"></span>, <?php echo e(__('voyager::media.height')); ?><span :id="'new-image-height_'+this._uid"></span>
                    </div>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(__('voyager::generic.cancel')); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="crop(false)"><?php echo e(__('voyager::media.crop')); ?></button>
                    <button type="button" class="btn btn-warning" v-on:click="crop(true)"><?php echo e(__('voyager::media.crop_and_create')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    Vue.component('media-manager', {
        template: `<?php echo $__env->yieldContent('media-manager'); ?>`,
        props: {
            basePath: {
                type: String,
                default: '/'
        ...
        methods: {
            getFiles: function() {
                var vm = this;
                vm.is_loading = true;
                $.post('<?php echo e(route('voyager.media.files')); ?>', { folder: vm.current_folder, _token: '<?php echo e(csrf_token()); ?>', details: vm.details }, function(data) {
                    vm.files = [];
                ...
                if (file.type != 'folder') {
                    if (!this.allowMultiSelect) {
                        ...
                        if (content.length >= this.maxSelectedFiles && this.maxSelectedFiles > 0) {
                            var msg_sing = "<?php echo e(trans_choice('voyager::media.max_files_select', 1)); ?>";
                            var msg_plur = "<?php echo e(trans_choice('voyager::media.max_files_select', 2)); ?>";
            ...
            renameFile: function(object) {
                ...
                $.post('<?php echo e(route('voyager.media.rename')); ?>', {
					...
					if (data.success == true) {
						toastr.success('<?php echo e(__('voyager::media.success_renamed')); ?>', "<?php echo e(__('voyager::generic.sweet_success')); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie')); ?>");
					}
				});
            },
            createFolder: function(e) {
                ...
                $.post('<?php echo e(route('voyager.media.new_folder')); ?>', { new_folder: vm.current_folder+'/'+name, _token: '<?php echo e(csrf_token()); ?>' }, function(data) {
					if(data.success == true){
						toastr.success('<?php echo e(__('voyager::generic.successfully_created')); ?> ' + name, "<?php echo e(__('voyager::generic.sweet_success')); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie')); ?>");
					}
            ...
            deleteFiles: function() {
                ...
                var vm = this;
                $.post('<?php echo e(route('voyager.media.delete')); ?>', {
                    path: vm.current_folder,
                    files: vm.selected_files,
                    _token: '<?php echo e(csrf_token()); ?>'
                }, function(data){
					if(data.success == true){
						toastr.success('', "<?php echo e(__('voyager::generic.sweet_success')); ?>");
						vm.getFiles();
            ...
            moveFiles: function(e) {
				...
				$.post('<?php echo e(route('voyager.media.move')); ?>', {
                    path: vm.current_folder,
                    files: vm.selected_files,
					...
					if(data.success == true){
						toastr.success('<?php echo e(__('voyager::media.success_moved')); ?>', "<?php echo e(__('voyager::generic.sweet_success')); ?>");
						vm.getFiles();
					} else {
						toastr.error(data.error, "<?php echo e(__('voyager::generic.whoopsie')); ?>");
					}
            ...
            crop: function(mode) {
                ...
                if (!mode) {
                    if (!window.confirm('<?php echo e(__('voyager::media.crop_override_confirm')); ?>')) {
						return;
					}
                }
                ...
                var vm = this;
                var postData = Object.assign(croppedData, { _token: '<?php echo e(csrf_token()); ?>' });
				$.post('<?php echo e(route('voyager.media.crop')); ?>', postData, function(data) {
					if (data.success) {
        ...
        mounted: function() {
            ...
            if (this.allowUpload && !dropzone.hasClass('dz-clickable')) {
                dropzone.dropzone({
                    timeout: 180000,
                    url: '<?php echo e(route('voyager.media.upload')); ?>',
                    ...
                    success: function(e, res) {
                        if (res.success) {
                            toastr.success(res.message, "<?php echo e(__('voyager::generic.sweet_success')); ?>");
                        } else {
                            toastr.error(res.message, "<?php echo e(__('voyager::generic.whoopsie')); ?>");
                        }
                    },
                    error: function(e, res, xhr) {
                        toastr.error(res, "<?php echo e(__('voyager::generic.whoopsie')); ?>");
                    },
                    ...
                    if (vm.hidden_element) {
                        if (vm.maxSelectedFiles > 1) {
                            ...
                            if (content.length < vm.minSelectedFiles) {
                                e.preventDefault();
                                var msg_sing = "<?php echo e(trans_choice('voyager::media.min_files_select', 1)); ?>";
                                var msg_plur = "<?php echo e(trans_choice('voyager::media.min_files_select', 2)); ?>";
                            ...
                            if (vm.minSelectedFiles > 0 && vm.hidden_element.value == '') {
                                e.preventDefault();
                                toastr.error("<?php echo e(trans_choice('voyager::media.min_files_select', 1)); ?>");
                            }
                        }
                    }
                });
...
<?php /**PATH C:\xampp\htdocs\zams\urbainx-32\urbinx\Urbainx\vendor\tcg\voyager\src/../resources/views/media/manager.blade.php ENDPATH**/ ?>