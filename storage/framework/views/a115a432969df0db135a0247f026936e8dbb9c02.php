...
<div>
    ...
    <div v-if="hidden_element">
        <div class="btn btn-sm btn-default" v-on:click="expanded = !expanded;" style="width:100%">
            <div v-if="!expanded"><i class="voyager-double-down"></i> <?php echo e(__('voyager::generic.open')); ?></div>
            <div v-if="expanded"><i class="voyager-double-up"></i> <?php echo e(__('voyager::generic.close')); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\Users\hello\Desktop\Urbainx\vendor\tcg\voyager\src/../resources/views/media/manager.blade.php ENDPATH**/ ?>