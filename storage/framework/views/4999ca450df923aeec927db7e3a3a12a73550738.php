                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="urbianxNav">
                            <ul class="navbar-nav mr-auto" id="urbianxMenu">
                               <!-- =============================== menu ================ -->
                                  <?php echo e(menu('Top-menu-german')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('login')); ?>"><i class=" icon-feather-user"></i> Willkommener Gast</a>
                                    <a class="dropdown-item" href="<?php echo e(route('register')); ?>"><i class=" icon-feather-log-in"></i> Registrieren Sie sich als einer von uns</a>
                                    </div>
                                </li>
                            </div> 
                            <!-- Signin btn -->  
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                        <a class="dropdown-item" href="<?php echo e(url('/admin/users')); ?>"><i class="icon-line-awesome-users"></i> Listen aktivieren </a>
                                        <a class="dropdown-item" href="<?php echo e(url('/admin')); ?>"><i class="icon-material-outline-settings"></i> die Einstellungen</a>
                                        <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('Ausloggen')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-flag"></i> Profil </a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-heart"></i> Liebling</a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>/edit"><i class="icon-feather-edit"></i> Profil bearbeiten</a>
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('Ausloggen')); ?>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo asset(Voyager::image(Auth::user()->avatar)); ?>" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>"><i class="icon-feather-flag"></i> Profil </a>
                                <a class="dropdown-item" href="<?php echo e(url('Listes')); ?>/create"><i class="icon-material-outline-assignment"></i> Listing hinzufügen  </a>
                                <a class="dropdown-item" href="<?php echo e(url('Users')); ?>/<?php echo e(Auth::user()->name); ?>/edit"><i class="icon-feather-edit"></i> Profil bearbeiten</a>
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i><?php echo e(__('Ausloggen')); ?>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>Copyright &copy; Alle Rechte vorbehalten 2020 | <?php echo e(setting('site.adress')); ?> | Tel <?php echo e(setting('site.Phone')); ?> 
...
<?php /**PATH C:\xampp\htdocs\zams\urbainx-32\codecanyon-23430909-urbainx-modern-directory-listing-script-theme\Urbainx\resources\views/German/layout/main.blade.php ENDPATH**/ ?>