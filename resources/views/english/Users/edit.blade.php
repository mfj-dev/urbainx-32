         ...
         {{ Form::open(['url'=>"Users/$User->name",'files' => 'true', 'method' => 'PUT','class' => 'contact100-form form-horizontal', 'enctype' => 'multipart/form-data']) }}
				...
				<span class="contact100-form-title">
                    ...
                    <div class="alert alert-success" role="alert" style="width: 100%;">
                        <p>Congratulations. Your Edit Account has been Book successfully :) </p>
                    </div>
                    @endif
                    <!--   ================  Messagge ================  -->
				...
				<div class="wrap-input100">
					<input  class="input100" name="dec" type="text" value="{{ $User->dec }}" placeholder="Please enter your dec...">

					<span class="focus-input100"></span>
				</div>
                <div class=" rs1">
					<input type="checkbox" name="role_id" value="3"> Be Lister Man<br>
					<span class="focus-input100"></span>
				</div>
				<div class="container-contact100-form-btn">
					<button type="submit" class="contact100-form-btn">Edit Account</button>
