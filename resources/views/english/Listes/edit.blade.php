...
<div class="container-contact100">
        ...
        {{ Form::open(['url'=>"Listes/$Liste->slug",'files' => 'true', 'method' => 'PUT','class' => 'contact100-form form-horizontal', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="wrap-input100 rs1">
                    <input  class="input100" type="text" name="List_name" placeholder="List Name" value="{{ $Liste->List_name }}">
                ...
                <div class="wrap-input100 rs1">
                    <select name="Category_id" class="input100" style="border: 0;padding: 0;width: 100%;" required> 
                        @if(isset($Liste->Category->name)) 
                          <option class="text-color" selected="selected" value="{{ $Liste->Category->name }}">{{ $Liste->Category->name }}</option>
                        @else
                        @endif
                        <!-- ============================= Category ============================= -->
                ...
                <div class="wrap-input100 rs1">
                    <select name="cities_id" class="selectpicker" style="border: 0;padding: 0;width: 100%;" required>
                        @if(isset($Liste->Cite->name)) 
                          <option class="text-color" selected="selected" value="{{ $Liste->Cite->name }}">{{ $Liste->Cite->name }}</option>
                        @else
                        @endif
                        <!-- ============================= City ============================= -->
                ...
                <div class="wrap-input100">
                    <input  class="input100" name="description" type="text"  placeholder="Please enter your dec..." value="{{ $Liste->description }}">
                    <span class="focus-input100"></span>
                </div>

                <div class="container-contact100-form-btn">
                    <button type="submit" class="contact100-form-btn">Edit</button>
