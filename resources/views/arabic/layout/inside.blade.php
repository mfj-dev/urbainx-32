...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/bootstrap-rtl.css') }}" media="all" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/rtl.css') }}" media="all" />
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                   <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#urbianxNav" aria-controls="urbianxNav" aria-expanded="false" aria-label="Toggle navigation"><span class=" icon-line-awesome-bars"></span></button>
                        <!-- Nav -->
                        <div class="collapse navbar-collapse" id="urbianxNav"> 
                            ...
                            <div class="urbianx-signin-btn">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2">
                                        <a class="dropdown-item" href="{{ route('login') }}"><i class=" icon-feather-user"></i> مرحبا بالضيف</a>
                                        <a class="dropdown-item" href="{{ route('register') }}"><i class=" icon-feather-log-in"></i> سجل لتكون واحد منا </a>
                                    </div>
                                </li>
                            </div> 
                            <!-- Signin btn -->  
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{!! asset(Voyager::image(Auth::user()->avatar)) !!}" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                        <a class="dropdown-item" href="{{ url('/admin/users') }}"><i class="icon-line-awesome-users"></i> إعدادات المستخدمين </a>
                                        <a class="dropdown-item" href="{{ url('/admin') }}"><i class="icon-material-outline-settings"></i> الإعدادات</a>
                                        <a class="dropdown-item" href="{{ route('logout') }}"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i>{{ __('الخروج') }}
                                        </a>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{!! asset(Voyager::image(Auth::user()->avatar)) !!}" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}"><i class="icon-feather-flag"></i> الملف الشخصي  </a>
                                <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}"><i class="icon-feather-heart"></i> مفضل </a>
                            <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}/edit"><i class="icon-feather-edit"></i> تعديل الملف الشخصي </a>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i>{{ __('الخروج') }}
                                        </a>
                            ...
                            <div class="urbianx-signin-btn">
                                ...
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{!! asset(Voyager::image(Auth::user()->avatar)) !!}" alt="Guest-image" style="width: 20%;float: right;">
                                    ...
                                    <div class="dropdown-menu menu-Gest" aria-labelledby="navbarDropdown2" style="margin: 2.125rem -45px 0;">
                                <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}"><i class="icon-feather-flag"></i> الملف الشخصي  </a>
                                <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}"><i class=" icon-material-outline-extension"></i> بلدي القوائم   </a>
                                <a class="dropdown-item" href="{{ url('Listes') }}/create"><i class="icon-material-outline-assignment"></i> إضافة قائمة  </a>
                                <a class="dropdown-item" href="{{ url('Users') }}/{{ Auth::user()->name }}/edit"><i class="icon-feather-edit"></i> تعديل الملف الشخصي </a>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                           onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            <i class="icon-material-outline-power-settings-new"></i>{{ __('الخروج') }}
    ...
    <!-- ***** Header Area End ***** -->
    <!-- ***** urb Area Start ***** -->
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url('{{ asset(Voyager::image(setting('home.Background-home'))) }}')"></div>
    <!-- ***** urb Area End ***** -->
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>حقوق النشر  &copy; جميع الحقوق محفوظة 2020  | {{ setting('site.adress') }} | الهاتف  {{ setting('site.Phone') }}</p>
                    </div>
