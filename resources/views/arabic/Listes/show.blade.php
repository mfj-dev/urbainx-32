    ...
    <div class="container">
            ...
            <div class="col-12 col-lg-8">
                <div class="single-listing-content">
                    ...
                    <div class="single-listing-nav">
                        <nav>
                            <ul id="listingNav">
                                ...
                                <li><a href="#review">التعليقات</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="overview-content mt-50" id="overview">
                        <p>{{ $Liste->description_arabic }}</p>
                    </div>
                    ...
                    <div class="contact-form contact-form-widget mt-50">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <input type="text" name="Reviews_title" class="form-control" placeholder="لقبك ">
                            </div>
                            <div class="col-12">
                             <select name="Reviews_star" class="form-control" class="custom-select " id="destinations">
                                <option selected="">استعراض نجمك </option>
                        ...
                        <div class="col-12">
                            <textarea name="Reviews_content" class="form-control"  cols="30" rows="10" placeholder="مراجعتك"></textarea>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn urbianx-btn" style="border-radius: 5px;">إعادة النظر </button>
                        </div>
                    </div>
                    {{ Form::close() }}
                    <!--   ================  review   ================  -->
        ...
        <div class="col-12 col-md-8 col-lg-4">
            ...
            <div class="listing-verify mt-40">
                <div id="single-job-map-container">
                    ...
                    <a href="#" id="streetView">منظر الشارع</a>
                </div>
            </div>
            <!-- Book A Table Widget -->
            <div class="book-a-table-widget mt-50">
                ...
                <button type="submit" class="btn urbianx-btn bg-white text-dark" style="width: 100%;">
                 <i class="icon-material-outline-access-time" aria-hidden="true"></i> إرسال  </button>
                 {{ Form::close() }}
                 <!--   ================  Books  ================  -->
             </div>
             <!-- Opening Hours Widget -->
             <div class="opening-hours-widget mt-50">
                <h6>نطاق السعر: من   {{ $Liste->Price_From }} إلى  {{ $Liste->Price_To }}  </h6>
            </div>
            <!-- Opening Hours Widget -->
            <!-- Opening Hours Widget -->
            <div class="opening-hours-widget mt-50">
        ...
        <div class="contact-form contact-form-widget mt-50" style="border-radius: 5px;">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <textarea name="Messages" class="form-control" cols="30" rows="10" placeholder="رسالتك "></textarea>
                </div>
                <div class="col-12">
                    <button type="submit" class="btn urbianx-btn"style="border-radius: 5px;">إرسال </button>
                </div>
            </div>
            {{ Form::close() }}
            <!--   ================  Books  ================  -->
