		...
		<div class="wrap-contact100">
				...
				<span class="contact100-form-title">
                    ...
                    <div class="alert alert-success" role="alert" style="width: 100%;">
                        <p>Herzliche Glückwünsche. Ihr Konto wurde erfolgreich gebucht :)  </p>
                    </div>
                    @endif
                    <!--   ================  Messagge ================  -->
				...
				<div class="wrap-input100">
					<input  class="input100" name="dec_german" type="text" value="{{ $User->dec_german }}" placeholder="Please enter your dec german...">

					<span class="focus-input100"></span>
				</div>
                <div class=" rs1">
					<input type="checkbox" name="role_id" value="3"> Lister sein<br>
					<span class="focus-input100"></span>
				</div>
				<div class="container-contact100-form-btn">
					<button type="submit" class="contact100-form-btn">Konto bearbeiten</button>
