            ...
            <div class="col-12 col-lg-8">
                <div class="single-listing-content">
                    ...
                    <div class="contact-form contact-form-widget mt-50">
                        <h6> Hallo :) und schreibe einen Kommentar </h6>
                        <!--   ================  Comment    ================  -->
                        ...
                        <div class="row">
                            <!-- ==================== News  =================== -->
                            <div class="col-12">
                                <textarea name="Comment_content" class="form-control" cols="30" rows="10" placeholder="Dein Kommentar"></textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn urbianx-btn" style="border-radius: 5px;">Kommentar </button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="listing-sidebar">
                ...
                <div class="author-widget mt-30 d-flex align-items-center">
                    ...
                    <div class="authors-name">
                        <!-- ==================== News  =================== -->
                        <a href="{{ url('News') }}/{{ $Post->slug }}">{!! substr($Post->title_german, 0, 40) !!}</a>
                        <!-- ==================== News  =================== -->
                        <p>{!! substr($Post->body_german, 0, 50) !!}</p>
                        <!-- ==================== News  =================== -->
                    </div>
                </div>
                @endforeach
