    ...
    <div class="container">
            ...
            <div class="col-12 col-lg-8">
                <div class="single-listing-content">
                    ...
                    <div class="contact-form contact-form-widget mt-50">
                        <h6> Bewerten Sie uns und schreiben Sie eine Bewertung </h6>
                        Bewertungen
                        <!--   ================  Reviews Doctor   ================  -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                               <select name="Reviews_star" class="form-control" class="custom-select " id="destinations">
                                <option selected="">Ihre Star Review</option>
                        ...
                        <div class="col-12">
                            <textarea name="Reviews_content" class="form-control"  cols="30" rows="10" placeholder="Your Rezension"></textarea>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn urbianx-btn" style="border-radius: 5px;">Rezension</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                    <!--   ================  review   ================  -->
        ...
        <div class="col-12 col-md-8 col-lg-4">
            ...
            <div class="book-a-table-widget mt-50">
                ...
                <button type="submit" class="btn urbianx-btn bg-white text-dark" style="width: 100%;">
                   <i class="icon-material-outline-access-time" aria-hidden="true"></i> Senden </button>
                   {{ Form::close() }}
                   <!--   ================  Books  ================  -->
               </div>
               <!-- Opening Hours Widget -->
               <div class="opening-hours-widget mt-50">
                <h6>Preisspanne : ab {{ $Liste->Price_From }} Zu {{ $Liste->Price_To }}</h6>
            </div>
            <!-- Opening Hours Widget -->
            <!-- Opening Hours Widget -->
            <div class="opening-hours-widget mt-50">
        ...
        <div class="contact-form contact-form-widget mt-50" style="border-radius: 5px;">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <textarea name="Messages" class="form-control" cols="30" rows="10" placeholder="Deine Nachricht"></textarea>
                </div>
                <div class="col-12">
                    <button type="submit" class="btn urbianx-btn"style="border-radius: 5px;">Senden</button>
                </div>
            </div>
            {{ Form::close() }}
            <!--   ================  Books  ================  -->
