...
<div class="container-contact100">
        ...
        {{ Form::open(['url'=>"Listes/$Liste->slug",'files' => 'true', 'method' => 'PUT','class' => 'contact100-form form-horizontal', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="alert alert-success" role="alert" style="width: 100%;">
                    <p>Congratulations. Your edit List has been successfully :) </p>
                </div>
                @endif
                <!--   ================  Messagge ================  -->
                <div class="wrap-input100 rs1">
                    <input  class="input100" type="text" name="List_name_german" placeholder="List Name" value="{{ $Liste->List_name_german }}">
                ...
                <div class="wrap-input100 rs1">
                    <select name="Category_id" class="input100" style="border: 0;padding: 0;width: 100%;" required> 
                        @if(isset($Liste->Category->name_german)) 
                          <option class="text-color" selected="selected" value="{{ $Liste->Category->name_german }}">{{ $Liste->Category->name_german }}</option>
                        @else
                        @endif
                        <!-- ============================= Category ============================= -->
                ...
                <div class="wrap-input100 rs1">
                    <select name="cities_id" class="selectpicker" style="border: 0;padding: 0;width: 100%;" required>
                        @if(isset($Liste->Cite->name)) 
                          <option class="text-color" selected="selected" value="{{ $Liste->Cite->name }}">{{ $Liste->Cite->City_name_german }}</option>
                        @else
                        @endif
                        <!-- ============================= City ============================= -->
                 ...
                 <div class="wrap-input100 rs1">
                    ...
                    <a href="https://www.maps.ie/coordinates.html" target="_blank">Karte abrufen</a>
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100">
                    <input  class="input100" name="description_german" type="text"  placeholder="Please enter your dec..." value="{{ $Liste->description_german }}">
                    <span class="focus-input100"></span>
                </div>

                <div class="container-contact100-form-btn">
                     <button type="submit" class="contact100-form-btn">Erstellen</button> 
                     <a class="contact100-form-btn" style="color: #fff" href="{{ url('Users') }}/{{ Auth::user()->name }}">
                     <i class=" icon-material-outline-account-circle"></i> Mein Profil </a>
                </div>
           {{ Form::close() }}
        </div>
    </div>
