...
<div class="container-contact100">
    ...
    {{ Form::open(['route' => ['Listes.store'], 'method' => 'POST','files' => 'true','class' => 'contact100-form form-horizontal', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="wrap-input100 rs1">
                    <input  class="input100" type="text" name="List_name_german" placeholder="List Name">
                ...
                <div class="wrap-input100 rs1">
                    <select name="Category_id" class="input100" style="border: 0;padding: 0;width: 100%;" required> 
                        <option class="text-color" selected="selected">Kategorie auflisten</option>
                        <!-- ============================= Category ============================= -->
                ...
                <div class="wrap-input100 rs1">
                    <select name="cities_id" class="selectpicker" style="border: 0;padding: 0;width: 100%;" required>
                        <option class="text-color" selected="selected">Stadt</option>
                        <!-- ============================= City ============================= -->
                ...
                <div class="wrap-input100">
                    <input  class="input100" name="description_german" type="text"  placeholder="Bitte geben Sie Ihr Datum ein ...">
                    <span class="focus-input100"></span>
                </div>
